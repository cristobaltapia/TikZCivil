...
\pgfkeys{
  ...
  hole position/right/.style = {
    hole position x = \beamWidth - \holeDiameter,
    hole position y = \beamHeight/2,
  },
  hole position/left/.style = {
    hole position x = \holeDiameter,
    hole position y = \beamHeight/2,
  },
  hole position x/.store in = \holePosX,
  hole position y/.store in = \holePosY,
  hole diameter/.store in   = \holeDiameter,
